...
return {
  ...
  opts = {
    ...
    dashboard = { enabled = false },   -- 关闭内置启动页（另行使用）
    dim = { enabled = true },          -- 失焦窗口变暗（split 时）
  },
  keys = {
    { "<leader>dd", function() Snacks.dashboard() end, desc = "Dashboard" },        -- 启动页
