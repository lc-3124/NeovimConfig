#!/bin/bash
# 自动生成于 2026-08-10 21:43，勿手改；来源: docs/aur-packages.txt
# 用法: ./docs/aur_install.sh   # 安装全部 AUR 包（--needed 已装则跳过）

paru -S adw-gtk-theme-git --needed --noconfirm ;
paru -S android-sdk-platform-tools --needed --noconfirm ;
paru -S animeko-appimage --needed --noconfirm ;
paru -S bibata-cursor-theme --needed --noconfirm ;
...
paru -S mainstream-audio --needed --noconfirm ;
paru -S mainstream-backlight --needed --noconfirm ;
paru -S mainstream-basic --needed --noconfirm ;
paru -S mainstream-fonts-themes --needed --noconfirm ;
paru -S mainstream-hyprland --needed --noconfirm ;
paru -S mainstream-portal --needed --noconfirm ;
...
paru -S opencode-desktop-bin --needed --noconfirm ;
